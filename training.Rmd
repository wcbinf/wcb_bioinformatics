...
-   [WCB introduction to Linux course](http://bifx-core.bio.ed.ac.uk/hyweldd/training/Bioinformatics_on_the_Command_Line/)
...
-   [WCB Introduction to Next-Gen Sequencing data analysis](http://bifx-core.bio.ed.ac.uk/training/NGS_workshop/NGS_workshop.html) (Linux command line)
...
-   [RNA-seq and differential expression analysis](https://ucdavis-bioinformatics-training.github.io/2019_March_UCSF_mRNAseq_Workshop/) (command line and R)

#### Hi-C

-   [WCB Hi-C data analysis workshop](http://bifx-core.bio.ed.ac.uk/Dan/Training/HiC_Workshop/HiC_Workshop_2019.html) (command line)
...
#### Annotating and plotting genomic data

-   [WCB Genomic data in R](http://bifx-core.bio.ed.ac.uk/training/ROI_workshop/R_roi_workshop.html) (R)
...
-   Training courses in R including many different HTS techniques.
